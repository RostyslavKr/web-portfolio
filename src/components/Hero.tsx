...
export default function HeroComponent() {
    return (
        <section id="intro"  >
            <div className="flex flex-col gap-y-3.5 px-5 mt-3 mb-12 md:px-14 md:gap-y-5 lg:px-28 lg:pb-28 lg:mb-20 mx-auto ">
                <Image src="/images/logo.svg" width={100} height={100} alt="logo" />
                <div className="lg:flex lg:items-center lg:justify-around">
                    <div className="lg:flex lg:flex-col lg:gap-y-5"><div className="flex items-center"><p className="font-medium text-lg text-slate-300 md:text-2xl">Hi there,I'm Rostyslav</p>
