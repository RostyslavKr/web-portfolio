...
const projects = [
    ...
    { title: "Ice Cream", description: "Ice cream store website with responsive layout, burger menu, modal window and attractive design.", img: "/images/projects/icecream.png", github: "https://github.com/RostyslavKr/ice-cream", site: "https://rostyslavkr.github.io/ice-cream/", built:"HTML5, SASS, JavaScript" },
    { title: "Filmoteka", description: "Application for searching movie.App component with Public and Private routes.", img: "/images/projects/filmoteka.png", github: "https://github.com/RostyslavKr/filmoteka", site: "https://rostyslavkr.github.io/filmoteka/", built:"HTML5, SASS, JavaScript, REST API" },
    ...
    {title:"Portfolio",description:"My portfolio website, the gateway to my digital universe. Here, you'll discover my journey, skills, and creative projects.The website is responsive and displays well on: desktop, tablet, mobile phone. ", img:"/images/projects/portfolio.png", github:"https://github.com/RostyslavKr/web-portfolio", site:"https://web-portfolio-tawny.vercel.app/", built:"Next.js, React, TypeScript, Tailwind"}
]
